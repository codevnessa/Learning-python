# COR PRETA 40 OU 100 (BRILHANTE)
print('\033[40mHello World!!!\033[m')

# COR VERMELHA 41 101 (BRILHANTE)
print('\033[41mHello World!!!\033[m')

# COR VERDE 42 OU 102 (BRILHANTE)
print('\033[42mHello World!!!\033[m')

# COR AMARELA 43 OU 103 (BRILHANTE)
print('\033[43mHello World!!!\033[m')

# COR AZUL 44 OU 104 (BRILHANTE)
print('\033[44mHello World!!!\033[m')

# COR MAGENTA 45 OU 105 (BRILHANTE)
print('\033[45mHello World!!!\033[m')

# COR CIANO 46 OU 106 (BRILHANTE)
print('\033[46mHello World!!!\033[m')

# COR BRANCA 47 OU 107 (BRILHANTE)
